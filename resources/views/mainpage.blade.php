                    ...
                    <div class="timeline">
                        ...
                        <div>
                            ...
                            <div class="timeline-item">
                                <span class="time"><i class="fas fa-clock"></i>
                                    {{ $terbaru->created_at->diffForhumans() }}</span>
                                <h3 class="timeline-header"><a href="#">{{ Auth::user()->username }} | </a>Foto - foto
                                    terbaru anda</h3>
                                <div class="timeline-body">
                                    @foreach ($galeri as $foto)
                                        <img src="{{ url('foto/' . $foto->foto) }}" alt="..." class="img-fluid"
                        ...
                        @foreach ($galeri as $g)
                            ...
                            <div>
                                <div class="timeline-item">
                                    <span class="time"><i class="fas fa-clock"></i>
                                        {{ $g->created_at->diffForHumans() }}</span>

                                    <h3 class="timeline-header"><a href="">{{ $g->judul }}</a> |
                                        <a href="" data-toggle="modal" data-target="#editfoto{{ $g->id_galery }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('editfoto/' . $g->id_galery) }}" method="post"
                                        ...
                                        <a href="" class="btn btn-sm btn-danger" data-toggle="modal"
                                            data-target="#hapusfoto{{ $g->id_galery }}">Hapus</a>
                                    </h3>
                                    ...
                                    <div class="modal fade" id="hapusfoto{{ $g->id_galery }}" z-index="30">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ url('hapusfoto/' . $g->id_galery) }}" method="DELETE"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                    ...
                                    <div class="timeline-body">
                                        <img src="{{ asset('/foto/' . $g->foto) }}" class="img-fluid" width="350"
                                            height="200">
                                    </div>
